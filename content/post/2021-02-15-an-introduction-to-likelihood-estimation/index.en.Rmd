---
title: An Annotated Introduction to Likelihood Estimation
author: admin
date: '2021-02-15'
slug: an-introduction-to-likelihood-estimation
categories: []
tags:
  - tutorial
...
summary: ''
authors: []
lastmod: '2021-02-15T13:58:05+01:00'
featured: no
image:
  caption: ''
  focal_point: 'center'
...
- icon: github
  icon_pack: fab
  name: Code
  url: "https://github.com/KennethEnevoldsen/KennethEnevoldsen.github.io/tree/master/content/post/2021-02-15-an-introduction-to-likelihood-estimation"
- name: Annotated Paper
  url: "https://journals.sagepub.com/doi/full/10.1177/2515245917744314#"
...
# Appendix
![](img/box1.png){width=60%}
![](img/box2.png){width=60%}

# References

## Original references:
![](img/ref1.png){width=30%}
![](img/ref2.png){width=30%} ![](img/ref3.png){width=30%}
