...
- icon: github
  icon_pack: fab
  name: Code
  url: "https://github.com/KennethEnevoldsen/missing"
- icon: download
  icon_pack: fas
  name: Download
  url: "link missing"
...
perf = tribble(
  ...
  "Polyglot",       NA,        64.95,      39.3,        78.74,       64.18,       NA,      NA,
  "NERDA (mBERT)",  NA,        80.75,      65.73,       92.66,       80.66,       NA,      NA,
  "Dacy mediuem (DaBERT v2)",   97.93,     83.09,      67.35,       89.62,                78.47,        87.88,   85.34,
